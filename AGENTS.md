# ads-analysis-15july-3

Ad Performance Analyzer: upload Meta/Google/TikTok ad CSVs, get AI-powered insights and prioritized recommendations, export a professional PDF report.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "305395415+nyswjyhh-collab@users.noreply.github.com"
  git config user.name "nyswjyhh-collab"
  ```
